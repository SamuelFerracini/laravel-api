...
const setShowMessage = (value) => (showMessage.value = value);
  ...
  <section id="contact" class="section bg-light-primary dark:bg-dark-primary">
    ...
    >
      <div class="flex flex-col items-center text-center">
        ...
        <p class="subtitle">
          I'm thrilled that you've taken the time to visit and get in touch with
          me. Whether you're interested in collaborating on a project, have a
          question or comment, or just want to say hello, I'm eager to hear from
          you.
        </p>
      </div>
        ...
        >
          <div class="flex flex-col lg:flex-row gap-x-4">
            ...
            <div>
              ...
              <p class="text-accent font-normal">I am here to help you.</p>
            </div>
          </div>
          <div class="flex flex-col lg:flex-row gap-x-4">
            <div
            ...
            <div>
              ...
              <p class="mb-1 text-paragraph">Adelaide, Australia.</p>
            </div>
          </div>
        </div>
